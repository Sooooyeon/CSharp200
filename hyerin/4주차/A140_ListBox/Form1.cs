...
namespace A140_ListBox
{
    public partial class Form1 : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txtIn1.Text = lst.SelectedIndex.ToString();
            txtIt1.Text = lst.SelectedItem.ToString();
        }

        private void listBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ListBox lst = sender as ListBox;
            txtIn2.Text = lst.SelectedIndex.ToString();
            txtIt2.Text = lst.SelectedItem.ToString();
        }

        private void listBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ListBox lst = sender as ListBox;
            txtIn3.Text = lst.SelectedIndex.ToString();
            txtIt3.Text = lst.SelectedItem.ToString();
        }
    }
}
